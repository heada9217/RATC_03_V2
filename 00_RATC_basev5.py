...
# checks if user responds with yes or no
def yes_no(question):

    yes_no_answers = ["yes","y","no","n"]
...
# calculate sides when given 2 sides
...
def instructions():
    ...
    if show_help == "Y":
        ...
        print() 
        #print instructions
        print("- This program will calculate the sides and angles of a right angled triangle with given input -")
        print()
        print("- To use this calculator, you must have atleast: ")
        print("  = Two sides")
        print("  = One side and one angle")
        print()
        print("- Sides are named of their opposing angles (eg; Adjacent side opposite to adjacent angle)")
        print()
        print("- enter 'xxx' to continue through code")
        print()
...
while keep_going == "yes" or "y":
    ...
    unrounded_sides_list = [hyp,opp,adj]
    rounded_sides_list = []


    for item in unrounded_sides_list:
        rounded_side = round_custom(item, round_decimal)
        rounded_sides_list.append(rounded_side)
        
    for item in rounded_sides_list:
    ...
    for item in calculate_angles:
        rounded_angle = round_custom(item, round_decimal)
        angle_data.append(rounded_angle)
    ...
    keep_going = yes_no("do you want another problem?: ")
