...
def angles(hyp, opp):
    calculated_angles = []
    angle_1_row = ["Angle 1 (opposite angle): "]
    angle_2_row = ["Angle 2:"]
    angle_3_row = ["Angle 3: 90"]
    ...
    angle_1_row.append(angle_1_deg)
    angle_2_row.append(angle_2_deg)
    
    calculated_angles.append(angle_1_row)
    calculated_angles.append(angle_2_row)
    calculated_angles.append(angle_3_row)
...
for item in range(0,6):
    ...
    if angle == "":
        ...
        print("*** Calculated sides ***")
        for item in pythag_side:
            print(item)
        print()

        # identify the last side to use to find angles
