...
if opp == "" and angle == "":
    ...
    angle_2 = 90 - angle_degrees

print ("*** Calculated Information ***")

print("opposite: {}".format(opp))
print("angle: {}".format(angle_degrees))
print("angle 2: {}".format(angle_2))
print("angle 3: 90")

#calculating only works specifically when hyp = 5 and adj = 3, to see if it worked with user input given.
