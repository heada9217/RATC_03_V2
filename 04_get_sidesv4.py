...
def get_side(side):
    ...
    while side == 1:
        ...
        a_side_row.append(length_side_1)
    ...
    while side == 2: 
        ...
        b_side_row.append(length_side_2)

    sides.append(hyp_side_row)
    sides.append(a_side_row)
    sides.append(b_side_row)
